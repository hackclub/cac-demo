...
export default function Home() {
  ...
  return (
        <div className = "h-[100vh] w-[100vw] bg-primary grid grid-rows-7 grid-cols-6 p-6 gap-6">
          ...
          <div className = "relative border bg-white p-8 border-black rounded-md col-span-full row-span-2 gap-2 justify-evenly overflow-auto">
            <AuthStatus className = "absolute top-0 left-1/2 -translate-x-1/2 "/>
